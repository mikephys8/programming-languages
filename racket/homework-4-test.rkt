...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps (lambda () (cons 1 ones)) 0) '() "stream-for-n-steps test")
   ...
   (check-equal? (vector-assoc 5 (vector (cons 2 1) 4 (cons 4 1) (cons 5 1))) (cons 5 1) "vector-assoc test")
